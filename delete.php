...
document.form1.submit(alert('A exclusão foi efetuada com sucesso')) ;
return true
}
    ...
    <div class="forms">
        ...
        <form id="cadastroforms" method="POST" action="delete.php?id=<?php echo $id ?>" name="form1">
        <div class="ladoalado">
        <div class = "inputBox">
        ...
        <br>
            ...
            <button type="submit" id="deletar" name="excluir" onclick="javascript: return validarForm()"> Excluir contato</button>
    </div>
    </form>
